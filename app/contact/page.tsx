        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              <p className="text-foreground/60 text-sm">mahathir@example.com</p>
            </a>
            ...
            >
              ...
              <p className="text-foreground/60 text-sm">Connect with me</p>
            </a>
            ...
            >
              ...
              <p className="text-foreground/60 text-sm">See my projects</p>
            </a>
          </div>
        </div>
      </div>
